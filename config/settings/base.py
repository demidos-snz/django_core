...
# fixme NAME_PROJECT, find django_core
NAME_PROJECT = os.path.basename(os.path.normpath(ROOT_DIR.root))

APPS_DIR = ROOT_DIR.path(NAME_PROJECT)
...
LOCAL_APPS = [
    ...
    "django_core.api_v1.apps.ApiV1Config",
    "django_core.ws.apps.WsConfig",
...
SPECTACULAR_SETTINGS = {
    "TITLE": f"{NAME_PROJECT.title()} API",
    "VERSION": "1.0.0",
    "SWAGGER_UI_SETTINGS": {
        "filter": True,
    },
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_SCHEMA_CLASS": "config.settings.schema.DjangoCoreAutoSchema",
}
