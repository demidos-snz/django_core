...
DJANGO_CORE_LOGGING_LEVEL = env.str("DJANGO_CORE_LOGGING_LEVEL", "WARNING")
DJANGO_CORE_LOGGING_DIR = env.str("LOG_DIR", f"/var/log/django_core/{hostname}")
...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "formatter": "verbose",
            "filename": f"{DJANGO_CORE_LOGGING_DIR}/{hostname}.log",
            "when": "midnight",
            "interval": 1,
            "backupCount": 10,
            "encoding": "utf-8",
    ...
    "loggers": {
        # root logger
        "": {
            "level": DJANGO_CORE_LOGGING_LEVEL,
            "handlers": ["file"],
        },
        "django": {
            "level": DJANGO_CORE_LOGGING_LEVEL,
...
release_version_file = env.str(
    ...
    efault="/etc/django_core/release",
)
